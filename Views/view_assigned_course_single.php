                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td><?php
                                                        ...
                                                        ?></td>
                                                    <td><?php echo $assigned_data['batch_no']; ?></td>
                                                    <td><?php echo $assigned_data['lead_trainer']; ?></td>
                                                    <td><?php echo $assigned_data['asst_trainer']; ?></td>
                                                    <td><?php echo $assigned_data['lab_asst']; ?></td>
                                                    <td><?php echo $assigned_data['lab_id']; ?></td>
                                                    <td><?php echo $assigned_data['start_date'].' - '.$assigned_data['ending_date']; ?></td>
                                                    <td><?php echo $assigned_data['start_time'] . ' - ' . $assigned_data['start_time']; ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                                <a href="#" class="label bg-teal dropdown-toggle" data-toggle="dropdown">Created</a>
                                                        </div>
                                                        <?php echo $assigned_data['created']; ?><br/>
                                                        <div class="btn-group">
                                                                <a href="#" class="label bg-teal dropdown-toggle" data-toggle="dropdown">Updated</a>
                                                        </div>
                                                        <?php if ($assigned_data['updated']=='0000-00-00 00:00:00') {echo 'Not Updated Yet';} else {echo $assigned_data['updated']; }?><br/>
                                                        <div class="btn-group">
                                                                <a href="#" class="label label-warning" data-toggle="dropdown">Deleted</a>
                                                        </div>
                                                        <?php if ($assigned_data['deleted']=='0000-00-00 00:00:00') {echo 'Not Deleted';} else {echo $assigned_data['deleted']; }?>
                                                    </td>
                                                    <td><?php echo $assigned_data['day']; ?></td>
                                                    <td><?php echo $assigned_data['assigned_by']; ?></td>
                                                </tr>
