                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo $user_data['created']; ?><br/>
                                                    <div class="btn-group">
                                                            <a href="#" class="label bg-teal dropdown-toggle" data-toggle="dropdown">Updated</a>
                                                    </div>
                                                    <?php if ($user_data['updated']=='0000-00-00 00:00:00') {echo 'Not Updated Yet';} else {echo $user_data['updated']; }?><br/>
                                                    <div class="btn-group">
                                                            <a href="#" class="label label-warning" data-toggle="dropdown">Deleted</a>
                                                    </div>
                                                    <?php if ($user_data['deleted']=='0000-00-00 00:00:00') {echo 'Not Deleted';} else {echo $user_data['deleted']; }?>
                                                </td>
                                                <td>
                                                    <ul class="icons-list">
                                                        <li><a href="#"><i class="icon-pencil7"></i></a></li>
                                                        <li><a href="delete_user.php?viewBy=deleted&id=<?php echo $user_data['id'];?>"><i class="icon-trash" title="Remove"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </tbody>
